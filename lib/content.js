...
var Content = {
  ...
  _buildContentModule: function buildContentModule(contentName, moduleDef) {
    ...
    this[contentName] = function (n) {
      ...
      return this;
      //rebuild child content baseSelector with result of _getSelector()
      //but if this[contentName] is called as an object, this is bypassed and
      //child content will have incorrect context css selector
    }.bind(moduleInstance);
